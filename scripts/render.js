...
(function() {
  var Application, CodeEditor, Feedback, MustHave, MustOrMustnt, Requirements, application, cortex, default_code, feedback, structure_types,
  ...
  Requirements = React.createClass({
    render: function() {
      ...
      return React.createElement("div", null, React.createElement("h2", null, "Exercise Settings"), React.createElement("table", {
        "className": "table"
      }, React.createElement("thead", null, React.createElement("th", null), React.createElement("th", null, "Required"), React.createElement("th", null, "Allowed"), React.createElement("th", null, "Banned")), React.createElement("tbody", null, structures)));
    }
  });
