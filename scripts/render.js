...
(function() {
  var Application, CodeEditor, Feedback, ListCheckbox, MustHave, Requirements, application, cortex, default_code, structure_types,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  CodeEditor = React.createClass({
    onChange: function(event) {
      return this.props.code.set(this.refs.text.getDOMNode().value);
    },
    render: function() {
      return React.createElement("div", null, React.createElement("h2", null, "Code"), React.createElement("textarea", {
        "onChange": this.onChange,
        "ref": "text",
        "value": this.props.code.val(),
  ...
  MustHave = React.createClass({
    render: function() {
      var ok;
      ok = this.props.ok ? React.createElement("span", {
      ...
      return React.createElement("li", null, ok, " ", this.props.value);
    }
  });
